...
namespace Helper.Commands
{
    ...
    {
        [RegisterHelperCommand("Prints a message to the console.", false)]
        ...
        [RegisterHelperCommand("Provides information about a method.", false)]
        ...
        [RegisterHelperCommand("Asks for administrator if the current process is not already an administrator.", false)]
        ...
        [RegisterHelperCommand("Installs helper to program files if it is not already installed", true)]
        public static void Install()
        {
            Installer.Install();
        }
        [RegisterHelperCommand("Prints how long it will be until charlie gets home to the console.", false)]
        ...
        [RegisterHelperCommand("Prints the environment directory to the console.", false)]
        public static void LogDirectory()
        {
            Console.WriteLine(Environment.CurrentDirectory);
        }
        [RegisterHelperCommand("Returns the environment directory to the console.", false)]
        public static string GetDirectory()
        {
            return Environment.CurrentDirectory;
        }
        [RegisterHelperCommand("Formats all the image files in a specifyied folder to the PNG format.", false)]
        ...
        [RegisterHelperCommand("Closes the current instance of helper.", false)]
        public static void Exit()
        {
            Process.GetCurrentProcess().Kill();
        }
        [RegisterHelperCommand("Prints the current helper version to the console.", false)]
        public static void Helper()
        {
            Assembly assembly = Assembly.GetCallingAssembly();
            Console.WriteLine($"Helper - {assembly.GetName().Version}");
        }
        [RegisterHelperCommand("Reads out a message using Microsofts text to speech.", false)]
        ...
        [RegisterHelperCommand("Reads out phil from small wenier club's voice mail.", false)]
        ...
        [RegisterHelperCommand("Opens the standard exeption log file in the default text editor.", false)]
        public static void ExceptionLog()
        {
            Process.Start(Program.GetRoot() + "\\ErrorLog.txt");
        }
        [RegisterHelperCommand("Lists all the currently registered methods", false)]
        ...
        [RegisterHelperCommand("Uses AES to encrypt a file.", false)]
        ...
        [RegisterHelperCommand("Uses AES to decrypt a file.", false)]
